    ...
    return (
      ...
      <View style={styles.product}>
        ...
        <View style={styles.containerContent}>
          <Text> Tên khách hàng : {this.props.tenkh} </Text> 
          <Text> Giá sản phẩm : {this.props.giaSP} </Text>
          <Text> Thời gian đặt hàng: {this.props.soLuong} </Text>
        ...
        <View style={styles.cuoi}>
           ...
           <View style={{width: 200, height: 15, flex: 1,  justifyContent: 'center', textAlign: 'center'}} >
            <Button title="trở về" onPress={() => this.props.navigation.navigate('dshoadon')}/>
           </View> 
        </View>
