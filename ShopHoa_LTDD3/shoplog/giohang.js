    ...
    return (
      ...
      <View style={styles.product}>
        ...
        <View style={styles.containerContent}>
          ...
          <Text> Giá sản phâtm : {this.props.giaSP} </Text>
          <Text> Số lượng: {this.props.soLuong} </Text>
          <View style={{width: 60, height: 15}}>
            <Button title="xóa" onPress={() => this.props.navigation.navigate('xoa')}/>
          </View>         
        </View> 
        </View>
        ...
        <View style={styles.cuoi}>
            <View style={{width: 200, height: 15, flex: 1,  justifyContent: 'center', textAlign: 'center'}} >
             <Button title="thanh toán" onPress={() => this.props.navigation.navigate('hoadon')}/>
            </View> 
           <View style={{width: 200, height: 15, flex: 1,  justifyContent: 'center', textAlign: 'center'}} >
            <Button title="trở về" onPress={() => this.props.navigation.navigate('sanpham')}/>
           </View> 
        </View>
